...
static constexpr auto STATUS_SERVER_DEVELOPERS = "Mark Samman,later modified by Mateus Roberto";
...
// Maximum clientId supported by client 8.60 to prevent rendering issues
static constexpr uint16_t MAX_CLIENT_ID_860 = 13000;
