-- GMFullLightOnEquipItem = true -- Client-side graphics parameter (removed for TFS 1.5 compatibility)
closedWorld = false
showMonsterExiva = true
-- antiBot = true -- Custom anti-bot parameter (removed for TFS 1.5 compatibility)
...
worldType = "pvp"
-- hotkeyAimbotEnabled = true -- Bot-related parameter (removed for TFS 1.5 compatibility)
protectionLevel = 50
killsToRedSkull = 100
